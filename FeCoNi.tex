...
\frame{
	\frametitle{}
	\vfill
	\adjincludegraphics[width=\textwidth]{img/prehistory.jpg}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{0.4\textwidth}
			\adjincludegraphics[width=\textwidth]{img/Geometrical_scratched_motive.jpg}
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{0.3\textwidth}
			\adjincludegraphics[height=0.8\textheight]{img/Dagger_Early_Bronze_Age.jpg}
		\end{column}
	\end{columns}
}
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{0.3\textwidth}
			...
			\adjincludegraphics[width=.9\textwidth]{img/Bas_fourneau.png}
		\end{column}
	\end{columns}
}
...
\frame{
	...
	\begin{columns}
		...
		\end{column}
		\begin{column}{0.3\textwidth}
			\adjincludegraphics[height=0.75\textheight]{img/Xuande_Archaic_Porcelain_Vase.jpg}
		\end{column}
	\end{columns}
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Čisté železo je do teploty 768~$^\circ$C (Curieho teplota\footnote[frame]{Nad Curieovou teplotou ztrácí látka své feromagnetické (či piezoelektrické) vlastnosti.}) feromagnetické.
		\item V práškovém stavu je pyroforické, v bulku se oxiduje vzduchem až za vyšší teploty.
		\item Ochotně se rozpouští ve zředěných kyselinách za vzniku železnatých solí.
		\item Oxidující kyseliny způsobují pasivaci povrchu.
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Má stříbrnou barvu s jemným modrým nádechem.
		\item Kobalt je ferromagnetický kov s Curieovou teplotou 1115~$^\circ$C.
...
\frame{
	...
	\begin{itemize}
		...
		\item S halogeny dává binární halogenidy.
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Je magnetický za laboratorní teploty, Curieova teplota je 354~$^\circ$C.
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.55\textheight]{img/Earth_poster.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Andradite-Hematite-cktsr-36a.jpg}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Calcite-Hematite-26306.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Bindheimite-Limonite-133774.jpg}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Galena_siderite_Cartagena.jpg}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Apatite-Siderite-Quartz.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Magnetite-163979.jpg}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Hematite-Magnetite-137557.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.7\textheight]{img/Fe_CO_5.png}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=0.35\textheight]{img/Struska.jpg}
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Safflorite.jpg}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
...
\frame{
	...
	\textbf{Skutterudit}
	\begin{itemize}
		\item Kubický minerál, \ce{CoAs3}, cínově bílá až šedá barva.\footnote[frame]{\href{https://mineraly.sci.muni.cz/sulfidy/skutterudit.html}{Skutterudit}}
...
\frame{
	...
	\begin{itemize}
		...
		\item Kobalt se sráží chlornanem:
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.4\textheight]{img/Cobalt_-_world_production_trend.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.35\textheight]{img/Pentlandite2.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Millerite-44389.jpg}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Calcite-Millerite-d06-24b.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Gersdorffite-38383.jpg}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Abelsonit.png}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
...
\frame{
	...
	\begin{itemize}
		...
		\item Druhou možností rafinace je \textit{Mondův proces}.
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{.55\textwidth}
			\begin{figure}
				\adjincludegraphics[width=\textwidth]{img/AlNiCo.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\vfill
		...
		\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.4\textheight]{img/Calumpit.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Možnou oblastí využití jsou baterie pro kardiostimulátory, ale i pro elektromobily, kde by mohlo železo nahradit dražší lithium.\footnote[frame]{\href{https://doi.org/10.3390/en3050960}{A High Capacity Li-Ion Cathode: The Fe(III/VI) Super-Iron Cathode}}
	\end{itemize}
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Jejich vysoká teplotní stabilita umožňuje konstrukci tepelně namáhaných částí plynových turbín.
		\item Také se využívají, díky korozní odolnosti, k výrobě ortopedických implantátů.
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.45\textheight]{img/Airstrikes_in_Syria.jpg}
	\end{figure}
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.6\textheight]{img/Lithium-cobalt-oxide-3D-balls.png}
	\end{figure}
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.4\textheight]{img/Li-Ion_batteries_for_mobile_phones.jpg}
	\end{figure}
}
...
\frame{
	...
	\begin{column}{.5\textwidth}
	\begin{figure}
		\adjincludegraphics[width=.8\textwidth]{img/Cobalt-60_Irradiator.jpg}
		\caption*{Pasterace potravin}
	\end{figure}
	\end{column}
	\end{columns}
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.35\textheight]{img/Sink_and_taps.jpg}
	\end{figure}
}
...
\frame{
	...
	\begin{column}{.5\textwidth}
		\begin{figure}
			\adjincludegraphics[height=.3\textheight]{img/Alloy_valves.jpg}
		\end{figure}
	\end{column}
	\end{columns}
}
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{.4\textwidth}
			\begin{figure}
				\adjincludegraphics[width=.95\textwidth]{img/Copper_electroplating.png}
			\end{figure}
		\end{column}
	\end{columns}
...
\frame{
	...
	\begin{columns}
		\begin{column}{.35\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.25\textheight]{img/FeO.jpg}
			\end{figure}
		\end{column}
		\begin{column}{.35\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.25\textheight]{img/FeO-xtal.png}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\textbf{Oxidy železa}
	\begin{itemize}
		\item \textbf{Oxid železnato-železitý}, \ce{Fe3O4}, se vyskytuje jako minerál \textit{magnetit}.
	...
	\begin{columns}
		\begin{column}{.35\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Fe3O4.jpg}
			\end{figure}
		\end{column}
		\begin{column}{.35\textwidth}
			\begin{figure}
...
\frame{
	...
	\begin{itemize}
		...
		\item Příkladem je i \ce{Fe3O4}, můžeme ho popsat jako \ce{Fe^{II}Fe$_2^{III}$O4}
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.4\textheight]{img/Kristallstruktur_Magnetit.png}
		\caption*{Železnaté ionty jsou zelené, železité modré}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{center}
		\adjincludegraphics[width=0.7\textwidth]{img/Rusty_car_in_River.jpg}
	\end{center}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Tato elektroda postupně koroduje a tím zabraňuje korozi předmětu.
		\item Využívá se hliník, hořčík a zinek.
		\item Tento druh ochrany se používá u nádrží, lodí, podzemních kabelech, apod.
	\end{itemize}
	\begin{center}
		\adjincludegraphics[width=0.6\textwidth]{img/Anode_sacrificielle_en_zinc.jpg}
	\end{center}
}
...
\frame{
	...
	\begin{tabular}{|c|c|c|c|}
		\hline
		\textbf{Halogenid} & \textbf{Barva} & \textbf{T$_t$ [$^\circ$C]} & \textbf{T$_v$ [$^\circ$C]} \\\hline
...
\frame{
	...
	\begin{itemize}
		\item V bezvodé podobě má strukturu \ce{BiI3} tvořenou oktaedry \ce{FeF6} propojenými chloridovými můstky. Připravuje se spalováním železa v chloru:
	...
	\begin{figure}
		\adjincludegraphics[height=.35\textheight]{img/Iron-trichloride-sheet-3D-polyhedra.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.75\textheight]{img/Etched_in_Ferric_Chloride_at_Home.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		\item Heptahydrát síranu železnatého, \ce{FeSO4.7 H2O}, zelená krystalická látka. V přírodě se vyskytuje jako minerál melanterit.\footnote[frame]{\href{http://mineraly.sci.muni.cz/sulfaty/melanterit.html}{Melanterit}}
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.35\textheight]{img/Iron-sulfate-heptahydrate-sample.jpg}
			\end{figure}
		\end{column}
		\begin{column}{.4\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.35\textheight]{img/Iron-sulfate-heptahydrate-3D.png}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Ferrocene.png}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Ferrocene_powdered.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[width=\textwidth]{img/Iron-pentacarbonyl-Berry-mechanism.png}
	\end{figure}
	\vfill
}
	...
	\begin{columns}
		\begin{column}{0.7\textwidth}
			...
			\begin{itemize}
				...
				\item \ce{4 K2FeO4 + 4 H2O -> 3 O2 + 2 Fe2O3 + 8 KOH}
			\end{itemize}
			\vfill
		\end{column}
		\begin{column}{0.3\textwidth}
			\begin{figure}
				\adjincludegraphics[width=\textwidth]{img/Ferrate_ion.png}
				\adjincludegraphics[width=.9\textwidth]{img/Potassiumferrate-VI-solution.png}
				\caption*{Roztok železanu draselného}
			\end{figure}
		\end{column}
	\end{columns}
}
...
\frame{
	...
	\begin{columns}
		\begin{column}{.4\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.3\textheight]{img/Cobaltous_chloride_anhydrous.jpg}
				\caption*{Bezvodý \ce{CoCl2}}
			\end{figure}
		\end{column}

		\begin{column}{.4\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.3\textheight]{img/Cobaltous_chloride.jpg}
				\caption*{\ce{CoCl2.6H2O}}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{columns}
		\begin{column}{.65\textwidth}
			\begin{figure}
				\adjincludegraphics[width=\textwidth]{img/NiO.png}
			\end{figure}
		\end{column}

		\begin{column}{.35\textwidth}
			\begin{figure}
				\adjincludegraphics[width=\textwidth]{img/Sodium-chloride-3D-ionic.png}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
